    ...
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          {/* Google SSO button placeholder — needs @react-oauth/google GoogleOAuthProvider wrapper */}
          <button type="button" className={styles.googleBtn}
            onClick={() => {
              // In production, use GoogleLogin component from @react-oauth/google
              // This is a placeholder for the UI
              alert(t('يتطلب إعداد Google OAuth', 'Requires Google OAuth setup'));
            }}>
            ...
            {t('الدخول بحساب جوجل', 'Sign in with Google')}
          </button>
        </form>
